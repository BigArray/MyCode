...
- (void)viewDidLoad {
    ...
    //    添加黄色轨道小车动画
    [self carAnimationWith:@"car" TrackLayer:_yellowTrack AnimationDuration:2.0 BeginTime:CACurrentMediaTime() + 1];
    
    //    添加绿色轨道小车动画
    [self carAnimationWith:@"otherCar" TrackLayer:_greenTrack AnimationDuration:5 BeginTime:CACurrentMediaTime()];
...
- (void)initSnowberg{
    ...
    UIColor *middleSnowColor = [UIColor colorWithRed:125.0 /255.0 green:87.0 /255.0 blue:7.0 /255.0 alpha:1.0];
...
- (void)initLawn{
    ...
    leftLawn.fillColor = [UIColor colorWithRed:82.0 / 255.0 green:177.0 / 255.0 blue:52.0 / 255.0 alpha:1.0].CGColor;
    ...
    rightLawn.fillColor = [UIColor colorWithRed:82.0 / 255.0 green:177.0 / 255.0 blue:52.0 / 255.0 alpha:1.0].CGColor;
...
- (void)initYellowTrack{
    ...
    _yellowTrack.strokeColor = [UIColor colorWithRed:210.0 / 255.0 green:179.0 / 255.0 blue:54.0 / 255.0 alpha:1.0].CGColor;
    ...
    trackLine.lineDashPattern = @[@5.0,@9.0];
...
- (void)initGreenTrack{
    ...
    _greenTrack.strokeColor = [UIColor colorWithRed:0.0 / 255.0 green:147.0 / 255.0 blue:163.0 /255.0  alpha:1.0].CGColor;
