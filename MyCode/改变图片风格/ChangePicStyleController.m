//
//  ChangePicStyleController.m
//  MyCode
//
//  Created by 中付支付 on 2018/3/16.
//  Copyright © 2018年 zzf. All rights reserved.
//

#import "ChangePicStyleController.h"
#import <GPUImage/GPUImage.h>

@interface ChangePicStyleController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ChangePicStyleController
...
- (void)viewDidLoad {
    ...
    _imageView.frame = CGRectMake(0, 64, self.view.bounds.size.width, 200);
    [self.view addSubview:_imageView];
    
    _tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 264, self.view.bounds.size.width, self.view.bounds.size.height-264) style:UITableViewStyleGrouped];
