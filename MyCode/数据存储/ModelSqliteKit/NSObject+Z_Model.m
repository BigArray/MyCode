...
#import "NSObject+Z_Model.h"
#import <objc/runtime.h>
#import <objc/message.h>

typedef NS_OPTIONS(NSUInteger, Z_TYPE) {
    _Array = 1 << 0,
    _Dictionary = 1 << 1,
    _String = 1 << 2,
    _Integer = 1 << 3,
...
@interface Z_ModelPropertyInfo : NSObject {
@public
    Class class;
    Z_TYPE type;
    SEL setter;
...
@end
@implementation Z_ModelPropertyInfo
...
@implementation NSObject (Z_Model)

#pragma mark - 枚举类属性列表 -

+ (void)z_EnumeratePropertyNameUsingBlock:(void (NS_NOESCAPE ^)(NSString * propertyName, NSUInteger index, BOOL * stop))block {
...
+ (void)z_EnumeratePropertyAttributesUsingBlock:(void (NS_NOESCAPE ^)(NSString * propertyName,objc_property_t property, NSUInteger index, BOOL * stop))block {
    unsigned int propertyCount = 0;
    BOOL stop = NO;
    objc_property_t * properties = class_copyPropertyList(self, &propertyCount);
    for (unsigned int i = 0; i < propertyCount; i++) {
...
- (void)copySuperObject:(id)newSelf {
    ...
    if (superClass != nil &&
        ...
        [superClass z_EnumeratePropertyNameUsingBlock:^(NSString *propertyName, NSUInteger index, BOOL *stop) {
...
- (id)z_Copy {
    ...
    [self.class z_EnumeratePropertyAttributesUsingBlock:^(NSString *propertyName, objc_property_t property, NSUInteger index, BOOL *stop) {
        NSDictionary <NSString *, Z_ModelPropertyInfo *> * propertyInfoMap = [self.class getModelPropertyDictionary];
        Z_ModelPropertyInfo * propertyInfo = nil;
        if (propertyInfoMap != nil) {
            propertyInfo = propertyInfoMap[propertyName];
        }
        if (propertyInfo == nil) {
            propertyInfo = [Z_ModelPropertyInfo new];
...
- (void)z_Encode:(NSCoder *)aCoder {
    ...
    if (superClass != nil &&
        ...
        [superObject z_Encode:aCoder];
    }
    [self.class z_EnumeratePropertyNameUsingBlock:^(NSString *propertyName, NSUInteger index, BOOL *stop) {
        id value = [self valueForKey:propertyName];
        if (value != nil) {
...
+ (id)z_ModelWithJson:(id)json {
    if (json) {
        if ([json isKindOfClass:[NSData class]]) {
            ...
            return [self z_ModelWithJson:jsonObject];
            ...
            return [self z_ModelWithJson:jsonData];
        }
    }
    return nil;
}
...
+ (id)z_ModelWithJson:(id)json keyPath:(NSString *)keyPath {
    if (json) {
        if (keyPath != nil && keyPath.length > 0) {
            ...
            return [self z_ModelWithJson:json];
        }
    }
    return nil;
}
...
- (NSDictionary *)z_Dictionary {
    ...
    if (superClass != nil &&
        ...
        [jsonDictionary setDictionary:[superObject z_Dictionary]];
    }
    NSDictionary <NSString *, Z_ModelPropertyInfo *> * propertyInfoMap = [self.class getModelPropertyDictionary];
    [self.class z_EnumeratePropertyAttributesUsingBlock:^(NSString *propertyName, objc_property_t property, NSUInteger index, BOOL *stop) {
        Z_ModelPropertyInfo * propertyInfo = nil;
        ...
        if (propertyInfo) {
            ...
            switch (propertyInfo->type) {
                ...
                case _Model: {
                    id value = ((id (*)(id, SEL))(void *) objc_msgSend)((id)self, propertyInfo->getter);
                    [jsonDictionary setObject:[value z_Dictionary] forKey:propertyName];
                }
                    break;
                case _Array: {
                    id value = ((id (*)(id, SEL))(void *) objc_msgSend)((id)self, propertyInfo->getter);
...
- (id)parserDictionaryEngine:(NSDictionary *)value {
    ...
    for (NSString * key in allKey) {
        ...
        if ([subValue isKindOfClass:[NSString class]] ||
            ...
            [subJsonDictionary setObject:[subValue z_Dictionary] forKey:key];
        }
    }
...
- (id)parserArrayEngine:(NSArray *)value {
    ...
    for (id subValue in value) {
        if ([subValue isKindOfClass:[NSString class]] ||
            ...
            [subJsonArray addObject:[subValue z_Dictionary]];
        }
    }
    return subJsonArray;
}
...
static const char  Z_ModelPropertyInfokey = '\0';
static const char  Z_ReplaceKeyValue = '\0';
static const char  Z_ReplacePropertyClass = '\0';
static const char  Z_ReplaceContainerElementClass = '\0';

+ (NSDictionary <NSString *, Class> *)getContainerElementClassMapper {
    return objc_getAssociatedObject(self, &Z_ReplaceContainerElementClass);
}

+ (void)setContainerElementClassMapper:(NSDictionary <NSString *, Class> *)mapper {
    objc_setAssociatedObject(self, &Z_ReplaceContainerElementClass, mapper, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

+ (NSDictionary <NSString *, Class> *)getModelPropertyClassMapper {
    return objc_getAssociatedObject(self, &Z_ReplacePropertyClass);
}

+ (void)setModelPropertyClassMapper:(NSDictionary <NSString *, Class> *)mapper {
    objc_setAssociatedObject(self, &Z_ReplacePropertyClass, mapper, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

+ (NSDictionary <NSString *, NSString *> *)getModelReplacePropertyMapper {
    return objc_getAssociatedObject(self, &Z_ReplaceKeyValue);
}

+ (void)setModelReplacePropertyMapper:(NSDictionary *)mapper {
    objc_setAssociatedObject(self, &Z_ReplaceKeyValue, mapper, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

+ (NSDictionary <NSString *, Z_ModelPropertyInfo *>*)getModelPropertyDictionary {
    return objc_getAssociatedObject(self, &Z_ModelPropertyInfokey);
}

+ (Z_ModelPropertyInfo *)getPropertyInfo:(NSString *)property {
    NSDictionary * propertyInfo = objc_getAssociatedObject(self, &Z_ModelPropertyInfokey);
    return propertyInfo != nil ? propertyInfo[property] : nil;
}

+ (void)setModelInfo:(Z_ModelPropertyInfo *)modelInfo property:(NSString *)property {
    NSMutableDictionary * propertyInfo = objc_getAssociatedObject(self, &Z_ModelPropertyInfokey);
    if (propertyInfo == nil) {
        propertyInfo = [NSMutableDictionary dictionary];
        objc_setAssociatedObject(self, &Z_ModelPropertyInfokey, propertyInfo, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
...
+ (Z_TYPE)parserTypeWithAttr:(NSString *)attr {
...
+ (Z_ModelPropertyInfo *)classExistProperty:(NSString *)property withObject:(NSObject *)object valueClass:(Class)valueClass {
    Z_ModelPropertyInfo * propertyInfo = nil;
    objc_property_t property_t = class_getProperty(object.class, [property UTF8String]);
    if (property_t != NULL) {
    ...
    if(object) {
        if([object isKindOfClass:[NSDictionary class]]) {
            ...
            if (replacePropertyNameMap == nil &&
                [class respondsToSelector:@selector(z_ModelReplacePropertyMapper)]) {
                replacePropertyNameMap = [class z_ModelReplacePropertyMapper];
            ...
            if ([class isSubclassOfClass:[NSDictionary class]]) {
                ...
                [dictionary enumerateKeysAndObjectsUsingBlock:^(NSString * key, id  _Nonnull obj, BOOL * _Nonnull stop) {
                    ...
                    Z_ModelPropertyInfo * propertyInfo = [class getPropertyInfo:actualProperty];
                    if (propertyInfo == nil || (propertyInfo != nil && propertyInfo->type == _Unknown)) {
                        if (replacePropertyClassMap) {
                            ...
                            if ([class respondsToSelector:@selector(z_ModelReplacePropertyClassMapper)]) {
                                [class setModelPropertyClassMapper:[class z_ModelReplacePropertyClassMapper]];
                            }
                    ...
                    switch (propertyInfo->type) {
                        case _Array:
                            if(![subObject isKindOfClass:[NSNull class]]){
                                ...
                                }else if ([class respondsToSelector:@selector(z_ModelReplaceContainerElementClassMapper)]) {
                                    replaceContainerElementClassMap = [class z_ModelReplaceContainerElementClassMapper];
                                    subModelClass = replaceContainerElementClassMap[actualProperty];
